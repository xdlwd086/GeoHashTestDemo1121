...
public class FileUtil {
    ...
    public static void getFileSDTGeoHashSDUMTAverageFromFileInitial(File fileSDTGeoHashSDUMT,File fileSDTGeoHashSDUMTAverage)throws Exception{
        SearchDepthAndTimeOfSDU[] sDTArray = new SearchDepthAndTimeOfSDU[40];
        //初始化操作
        for(int i=1;i<=29;i++){
        ...
        for(int i=1;i<=29;i++){
            ...
            sDTArray[i].timeOfPhoenixGeoHashSecondFiltering /= 30;
